...
// -----
  ...
  // CHECK-LABEL: func.func @nested_for_replacement_keeps_outer_main_loop                                                                                                                             
  // CHECK: scf.for
  // CHECK-SAME: {ssbuffer.block_id = 16 : i32}
  // CHECK-NOT: ssbuffer.main_loop
  // CHECK-NEXT: }
  // CHECK: scf.for
  // CHECK-SAME: {ssbuffer.block_id = 17 : i32, ssbuffer.core_type = "VECTOR", ssbuffer.main_loop = 0 : i32}
...
// -----
  ...
  // CHECK-LABEL: func.func @nested_multi_for_main_loop_not_inner                                                                                                                                           
  // CHECK: scf.for
  // CHECK-SAME: {ssbuffer.block_id = 16 : i32}
  // CHECK-NOT: ssbuffer.main_loop
  ...
  // CHECK-NEXT: }
  // CHECK: scf.for
  // CHECK-SAME: {ssbuffer.pipe_stage = 3 : i32}
  // CHECK-NOT: ssbuffer.main_loop
  // CHECK-NOT: ssbuffer.block_id
  // CHECK-NEXT: scf.yield
  // CHECK-NEXT: }
  // CHECK: scf.for
  // CHECK-SAME: {ssbuffer.main_loop = 0 : i32}
  // CHECK-NOT: block_id
  // CHECK-NOT: pipe_stage

  module {
    func.func @nested_multi_for_main_loop_not_inner(%seed: i32) -> i32 {
      %c0_i32 = arith.constant 0 : i32
      %c1_i32 = arith.constant 1 : i32
      %c0 = arith.constant 0 : index
      %c2 = arith.constant 2 : index
